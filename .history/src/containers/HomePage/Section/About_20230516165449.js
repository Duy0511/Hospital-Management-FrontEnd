            ...
            <div className="section-share section-about">
                ...
                <div className="section-about-content">
                    ...
                    <div className="content-right">
                        ...
                        <p>Thực hiện lối sống healthy mang lại nhiều lợi ích cho cuộc sống của bạn và sức khỏe như:</p>
                            <pa> Tiết kiệm tiền</pa>
                            <p> Tốt cho môi trường</p>
                            <p> Ngăn ngừa mắc bệnh ung thư</p>
                            <p> Ngăn ngừa mắc bệnh gan nhiễm mỡ </p>
                            <p> Kéo dài tuổi thọ</p>
                            <p> Ngăn ngừa lão hóa da</p>
                    </div>
                </div>
            </div>
        );
